...
function tripItineraries () {


  return m(".ibox.float-e-margins", [
    m(".ibox-content", [
      m("ul[role='tablist']",
        [m("li.first.current[aria-disabled='false'][aria-selected='true'][role='tab']",
        [m("a[aria-controls='wizard-p-0'][href='#wizard-h-0'][id='wizard-t-0']",
        [m("span.current-info.audible", "current step: "),m("span.number", "1.")," First Step"])])
        // ,m("li.disabled[aria-disabled='true'][role='tab']",
        // [m("a[aria-controls='wizard-p-1'][href='#wizard-h-1'][id='wizard-t-1']",
        // [m("span.number", "2.")," Second Step"])]),m("li.disabled.last[aria-disabled='true'][role='tab']",
        // [m("a[aria-controls='wizard-p-2'][href='#wizard-h-2'][id='wizard-t-2']",
        // [m("span.number", "3.")," Third Step"])
        // ])
      ])
    ])
  ])
